...
require_once 'C:/OpenServer/vendor/fzaninotto/Faker/src/autoload.php';
...
// 			(Manager_pasport_number, Surname, Name, Father_name, Birthday, Salary) 
// 			VALUES('$passport_number',
// 			 '$faker->firstNameMale', '$faker->middleName','$faker->lastName', '$dateBirth', '$salary')";
